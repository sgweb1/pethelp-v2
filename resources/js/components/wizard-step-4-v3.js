...
if (typeof window !== 'undefined') {
    window.wizardStep4 = wizardStep4;
    ...
    window.setWeekdaysOnly = function() {
        ...
        if (component) {
            ...
            console.error('🔴 wizardStep4 component not found for setWeekdaysOnly');
        }
    };
    ...
    window.setFullWeek = function() {
        ...
        if (component) {
            ...
            console.error('🔴 wizardStep4 component not found for setFullWeek');
        }
    };
    ...
    window.setWeekendsOnly = function() {
        ...
        if (component) {
            ...
            console.error('🔴 wizardStep4 component not found for setWeekendsOnly');
        }
    };
    ...
    window.setFlexibleSchedule = function() {
        ...
        if (component) {
            ...
            console.error('🔴 wizardStep4 component not found for setFlexibleSchedule');
        }
    };

    /**
     * Znajduje aktywny komponent wizardStep4 w DOM
     */
    function findActiveWizardStep6Component() {
        try {
            // Szukaj elementu z x-data="wizardStep4()"
            const wizardElements = document.querySelectorAll('[x-data*="wizardStep4"]');
            ...
            console.warn('⚠️ wizardStep4 component not found or not initialized');
            return null;
        } catch (error) {
            console.error('🔴 Error finding wizardStep4 component:', error);
            return null;
        }
    }
}