    ...
    <div class="bg-white dark:bg-gray-900 rounded-t-3xl relative z-20 -mt-8">
        <div class="pt-8 pb-8 space-y-6">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <!-- My Pets Action -->
                <a href="{{ route('profile.pets.index') }}" class="group bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 text-center cursor-pointer transition-all duration-300 hover:bg-white/20 hover:scale-105 hover:shadow-xl">
                ...
                <!-- Gallery Action -->
                <a href="{{ route('profile.gallery.index') }}" class="group bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 text-center cursor-pointer transition-all duration-300 hover:bg-white/20 hover:scale-105 hover:shadow-xl">
                    <div class="text-4xl mb-3 group-hover:scale-110 transition-transform">📸</div>
                ...
                <!-- Services Action -->
                @if(auth()->user()->isSitter())
                    <a href="{{ route('profile.services.index') }}" class="group bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 text-center cursor-pointer transition-all duration-300 hover:bg-white/20 hover:scale-105 hover:shadow-xl">
                        <div class="text-4xl mb-3 group-hover:scale-110 transition-transform">🔧</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <x-ui.button variant="primary" fullWidth="true">
                                    <a href="{{ route('profile.pets.create') }}" class="flex items-center justify-center w-full h-full">
                                ...
                                @if(auth()->user()->isSitter())
                                    <x-ui.button variant="secondary" fullWidth="true">
                                        <a href="{{ route('profile.services.create') }}" class="flex items-center justify-center w-full h-full">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-6">
                    ...
                    <x-ui.card variant="default" :shadow="true" class="backdrop-blur-md bg-white/95 dark:bg-gray-800/95">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('profile.pets.index') }}" class="flex items-center py-2 px-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                            ...
                            <a href="{{ route('profile.gallery.index') }}" class="flex items-center py-2 px-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                                <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @if(auth()->user()->isSitter())
                                <a href="{{ route('profile.services.index') }}" class="flex items-center py-2 px-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2V6"></path>
                                    </svg>
                                    Oferta
